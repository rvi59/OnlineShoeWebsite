<%@ Page Title="" Language="C#" MasterPageFile="~/Shoe.Master" AutoEventWireup="true" CodeBehind="WomensList.aspx.cs" Inherits="OnlineShoeWebsite.WomensList" %>
     ...
     <div>
          <br />
            <div class="text-center bg-light">
                <label class="font-weight-bolder" style="font-size: 22px;">Womens Shoes</label>
            </div>

            <asp:DataList ID="dlWomens" runat="server" RepeatDirection="Horizontal" RepeatColumns="4" CssClass="mycasual">
                <ItemTemplate>
