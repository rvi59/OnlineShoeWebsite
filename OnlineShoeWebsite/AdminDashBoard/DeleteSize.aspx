<%@ Page Title="" Language="C#" MasterPageFile="~/AdminDashBoard/Admin.Master" AutoEventWireup="true" CodeBehind="DeleteSize.aspx.cs" Inherits="OnlineShoeWebsite.AdminDashBoard.DeleteSize" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container">
        ...
        <br />
        <asp:Label ID="lbl1" Font-Bold="true" Text="Size Short Summary" runat="server" /><br />
        <br />
