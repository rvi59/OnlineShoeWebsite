<%@ Page Title="" Language="C#" MasterPageFile="~/AdminDashBoard/Admin.Master" AutoEventWireup="true" CodeBehind="DeleteBrand.aspx.cs" Inherits="OnlineShoeWebsite.AdminDashBoard.DeleteBrand" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container">
        ...
        <br />
        <asp:Label ID="lbl1" Font-Bold="true" Text="Brand Short Summary" runat="server" /><br />
        <br />
